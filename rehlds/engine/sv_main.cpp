...
{
	Con_Printf("here 1");
	return SV_CheckUserInfo_internal(adr, userinfo, bIsReconnecting, nReconnectSlot, name); //g_RehldsHookchains.m_SV_CheckUserInfo.callChain(SV_CheckUserInfo_internal, adr, userinfo, bIsReconnecting, nReconnectSlot, name);
}
